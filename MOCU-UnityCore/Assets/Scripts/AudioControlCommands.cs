...
namespace AudioControl {
    ...
    {
        public string Command           { get; set; } = "GeneralResponseFromServer_Command";
        public string ReceivedCommand   { get; set; }
        public bool HasError            { get; set; }
    ...
    {
        public string Command               { get; set; } = "ResponseFromServer_GetAudioDevices_Command";
        public string ReceivedCommand       { get; set; } = "GetAudioDevices_Command";
    ...
    {
        public string Command { get; set; } = "StartIntercomStream_ParticipantToResearcher_Command";
    }

    public class StopIntercomStream_ResearcherToParticipant_Command : GeneralCommandToServer
    {
        public string Command { get; set; } = "StopIntercomStream_ResearcherToParticipant_Command";
    }
    
    public class StopIntercomStream_ParticipantToResearcher_Command : GeneralCommandToServer
    {
        public string Command { get; set; } = "StopIntercomStream_ParticipantToResearcher_Command";
    }

    // different -------------------------------------------------------------------------------------------------
    public class PlayAudioFile_Command : GeneralCommandToServer
    {
        public string Command               { get; set; } = "PlayAudioFile_Command";
    ...
    {
        public string Command { get; set; } = "SendConfigs_Command";
    ...
    {
        public string Command   { get; set; } = "GetAudioDevices_Command";
    ...
    {
        public string Command                           { get; set; } = "SetDevicesParameters_Command";
    ...
    {
        public string Command   { get; set; } = "ChangeOutputDeviceVolume_Command";
