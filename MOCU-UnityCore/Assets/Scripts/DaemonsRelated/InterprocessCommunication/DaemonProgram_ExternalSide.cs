...
namespace DaemonsNamespace.InterprocessCommunication
{
    ...
    {
        private Thread parentProcessMonitoring_Thread;
        private Thread interprocessCommunication_Thread;
        private Thread programLogicExecution_Thread;
        ...
        public void RunDaemon()
        {
            ...
            communicationServer = new NamedPipeServer(
                namedPipeName: namedPipeName,
                inputQueue: new ObservableConcurrentQueue<string>(inputMessageProcessor),
                outputQueue: new ObservableConcurrentQueue<string>(outputMessageProcessor)
            );
        ...
        {
            parentProcessMonitoring_Thread = new Thread(() =>
            {
            ...
            parentProcessMonitoring_Thread.Start();
        }
