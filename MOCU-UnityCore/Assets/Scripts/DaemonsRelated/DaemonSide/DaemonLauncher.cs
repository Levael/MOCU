...
namespace DaemonsRelated
{
    ...
    {
        /*public DaemonLauncher(IDaemonLogic daemonLogic, IHostAPI hostAPI, InterprocessCommunicator_Client communicator)
        {
        ...
        public void Launch(string[] arguments)
        {
            ...
            DaemonsUtilities.ConsoleInfo($"Daemon name: {arguments[1]}");
